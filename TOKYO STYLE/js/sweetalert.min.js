...
function validarCadastro() {
	...
	if(checkbox.checked) {
        ...
        swal({
            title:'Please accept the terms to complete the registration!', 
            icon: 'warning',
            });
		return;
	}
...
function processarPagamento() {
	...
	if (card.value == "" || nameOfCard.value== "" || validityCard.value == "" || SecurityCode.value== "") {
      swal({
        title:'Please enter all payment information.', 
        icon: 'warning',
        });
	  ...
	  return;
        ...
        swal({
            title:'We are processing your purchase, thank you.', 
            icon: 'success',
            });	
	}
...
function validarTamanho(){
    var tamanhoP = document.getElementById("pequeno");
    var tamanhoM = document.getElementById("medio");
    var tamanhoG = document.getElementById("grande");


    if(tamanhoP.checked || tamanhoM.checked || tamanhoG.checked){
...
function validarTamanho2(){
    var tamanho1 = document.getElementById("tam1");
    var tamanho2 = document.getElementById("tam2");
    var tamanho3 = document.getElementById("tam3");
    var tamanho4 = document.getElementById("tam4");
    var tamanho5 = document.getElementById("tam5");


    if(tamanho1.checked || tamanho2.checked || tamanho3.checked || tamanho4.checked || tamanho5.checked){
